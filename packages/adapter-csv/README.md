...
The parser handles UTF-8 BOMs, CRLF, quoted commas/newlines and escaped quotes, and rejects malformed numbers, booleans, dates and movement types before they can reach the engine.
