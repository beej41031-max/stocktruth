...
const layers = [
  ...
  ['CANONICAL EVIDENCE', 'book claims · observations · movements · source health · two timelines'],
  ['DETERMINISTIC ENGINE', 'chronology · invariants · contradictions · as-of reconstruction'],
  ['ASSERTION', 'state a number, qualify it, or refuse it — always with evidence'],
] as const;
